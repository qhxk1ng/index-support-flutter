...
abstract class AdminRemoteDataSource {
  ...
  Future<Map<String, dynamic>> getComplaintTrack(String complaintId);

  Future<List<WarrantyModel>> getPendingWarranties();

  Future<void> approveWarranty({required String warrantyId});
...
class AdminRemoteDataSourceImpl implements AdminRemoteDataSource {
  ...
  Future<Map<String, dynamic>> getComplaintTrack(String complaintId) async {
  ...
  Future<List<WarrantyModel>> getPendingWarranties() async {

    final response = await apiClient.get('/admin/warranty/warranties/pending');
  ...
  Future<void> approveWarranty({required String warrantyId}) async {

    await apiClient.post('/admin/warranty/warranties/$warrantyId/approve');

  }

  @override

  Future<void> rejectWarranty({required String warrantyId, required String reason}) async {
